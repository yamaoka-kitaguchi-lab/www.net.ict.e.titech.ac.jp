$(document).ready(() => {
  ...
  const past_members_url = "https://raw.githubusercontent.com/yamaoka-kitaguchi-lab/members/master/past_members.json";
  ...
  const build_past_members_list = (json) => {
    console.log(json);
  };
  ...
  fetch_and_build(past_members_url, build_past_members_list);
});
